define([
  ...
  return function(options) {
    ...
    var config = {
      ...
      strings: i18n.print.bannerNotification
    };
    ...
    if (!isHidden() && isUniqueNotification(settings.id)) {
      var styleTag = '\
        <style type="text/css">\
          ...
          .banner-notification .banner-notification-text {\
            font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;\
          }\
      ...
      var miniMsgTemplate = '\
        <div class="mini-msg-popup">\
          <p class="banner-notification-text">' + settings.bannerMsg + '</p>&nbsp;\
      ...
      var mainMsgTemplate = '\
        <div class="main-msg-wrapper">\
          <div class="text-column-wrapper">\
            ...
            <label class="banner-notification-text" for="'+ settings.id + '-banner-notification-dont-show">' + settings.dontShowAgainText + '</label>\
            </form>\
