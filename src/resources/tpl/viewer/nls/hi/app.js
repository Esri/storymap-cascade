...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupportOther": "कैस्केड स्टोरी किसी भी आधुनिक वेब ब्राउज़र में देखी जा सकती हैं लेकिन स्टोरी मैप कैस्केड बिल्डर केवल ${CHROME}, ${SAFARI}, और ${FIREFOX} (बीटा) में समर्थित है।<br><br>अगर आपको किसी अलग ब्राउज़र का समर्थन करने वाले कैस्केड बिल्डर की आवश्यकता है, तो कृपया ${ESRI-SUPPORT} या ${BROWSER-SUPPORT-VOTE} से संपर्क करें।",
