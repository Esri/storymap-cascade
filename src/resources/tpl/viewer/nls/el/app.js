...
define({
  "viewer": {
    ...
    "errors": {
      ...
      "builderSupportOther": "Οι αφηγήσεις που εκπονούνται μέσω Cascade μπορούν να προβληθούν σε οποιοδήποτε σύγχρονο πρόγραμμα περιήγησης στο web, αλλά το Εργαλείο δημιουργίας Story Map Cascade υποστηρίζεται μόνο σε ${CHROME}, ${SAFARI} και ${FIREFOX} (δοκιμαστική έκδοση).<br><br>Αν χρειάζεστε την υποστήριξη κάποιου άλλου προγράμματος περιήγησης από το Εργαλείο δημιουργίας Cascade, αποταθείτε στην υπηρεσία ${ESRI-SUPPORT} ή ${BROWSER-SUPPORT-VOTE}.",
