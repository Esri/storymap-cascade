        ...
        "providers": {
          ...
          "urlContent": {
            ...
            "uploadErrors": {
              ...
              "imageAndVideo2": "Lisage pildi (.jpg, .png, .gif) link või valige video rakendusest ${YouTube} või ${YouTube} või valige pilt rakendusest ${ArcGIS}, ${Flickr}, ${Google+} või ${Unsplash}.",
