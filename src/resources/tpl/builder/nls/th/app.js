  ...
  "builder": {
    ...
    "mediaErrors": {
      ...
      "descriptions": {
        ...
        "httpAudioUncheckable": "เสียงนี้มี URL (HTTP) ที่ไม่ปลอดภัย คลิกปุ่มด้านล่างเพื่อลองใช้ URL ของ HTTPS สำหรับเสียงนี้ หากใช้งานไม่ได้ ให้ลบเสียงออกจากเรื่องราวของคุณหรือแทนที่ด้วยไฮเปอร์ลิงก์",
        ...
        "httpWebpageUncheckable": "หน้าเว็บนี้มี URL (HTTP) ที่ไม่ปลอดภัย คลิกปุ่มด้านล่างเพื่อลองใช้ URL ของ HTTPS สำหรับหน้าเว็บนี้ หากใช้งานไม่ได้ ให้ลบเว็บเพจออกจากเรื่องราวของคุณหรือแทนที่ด้วยภาพหน้าจอหรือไฮเปอร์ลิงก์",
        ...
        "httpVideoUncheckable": "วิดีโอนี้มี URL (HTTP) ที่ไม่ปลอดภัย คลิกปุ่มด้านล่างเพื่อลองใช้ URL ของ HTTPS สำหรับวิดีโอนี้ หากใช้งานไม่ได้ ให้ลบวิดีโอออกจากเรื่องราวของคุณหรือแทนที่ด้วยภาพหน้าจอหรือไฮเปอร์ลิงก์",
        ...
        "httpImageUncheckable": "ภาพนี้มี URL (HTTP) ที่ไม่ปลอดภัย คลิกปุ่มด้านล่างเพื่อลองใช้ URL ของ HTTPS สำหรับภาพนี้ หากใช้งานไม่ได้ ให้ลบรูปภาพออกจากเรื่องราวของคุณหรือแทนที่ด้วยไฮเปอร์ลิงก์",
      ...
      "tooltips": {
        ...
        "httpAudioUncheckable": "ลองใช้ URL ของ HTTPS สำหรับเสียงนี้ หากใช้งานไม่ได้ ให้ลบเสียงออกจากเรื่องราวของคุณหรือแทนที่ด้วยลิงก์",
        "httpWebpageFixable": "คลิกปุ่มเพื่อใช้ URL ของ HTTPS ที่ปลอดภัยสำหรับหน้าเว็บนี้",
        "httpWebpageUncheckable": "ลองใช้ URL ของ HTTPS สำหรับหน้าเว็บนี้ หากใช้งานไม่ได้ ให้ลบเว็บเพจออกจากเรื่องราวของคุณหรือแทนที่ด้วยภาพหน้าจอหรือลิงก์",
        "httpVideoFixable": "คลิกปุ่มเพื่อใช้ URL ของ HTTPS ที่ปลอดภัยสำหรับวิดีโอนี้",
        "httpVideoUncheckable": "ลองใช้ URL ของ HTTPS สำหรับวิดีโอนี้ หากใช้งานไม่ได้ ให้ลบวิดีโอออกจากเรื่องราวของคุณหรือแทนที่ด้วยภาพหน้าจอหรือลิงก์",
        "httpImageFixable": "คลิกปุ่มเพื่อใช้ URL ของ HTTPS ที่ปลอดภัยสำหรับภาพนี้",
        "httpImageUncheckable": "ลองใช้ URL ของ HTTPS สำหรับภาพนี้ หากใช้งานไม่ได้ ให้ลบรูปภาพออกจากเรื่องราวของคุณหรือแทนที่ด้วยภาพหน้าจอหรือลิงก์",
