...
define({
  "builder": {
    ...
    "extendedSupportMessage": {
      "bannerMsg": "従来の Esri ストーリー マップは延長サポートになっています",
      "s1h1": "従来の Esri ストーリー マップに関する重要なメッセージ",
      "s1p1": "従来の Esri ストーリー マップ テンプレートは延長サポートになっています すべてのお客様に Esri の現世代のストーリーテリング ツールである ArcGIS StoryMaps を使用することをお勧めします。",
    ...
    "matureSupportMessage": {
      "bannerMsg": "従来の Esri ストーリー マップは開発終了バージョン サポートになっています",
      "s1h1": "従来の Esri ストーリー マップに関する重要なメッセージ",
      "s1p1": "従来の Esri ストーリー マップ テンプレートは開発終了バージョン サポートになっています すべてのお客様に Esri の現世代のストーリーテリング ツールである ArcGIS StoryMaps を使用することをお勧めします。",
      "s1p2": "従来のテンプレートは開発が終了したため、新しいプロジェクトにはお勧めしません。 今後の機能の更新は計画されていません。 従来のテンプレートを使用して作成されたストーリーは、引き続き使用できます。",
