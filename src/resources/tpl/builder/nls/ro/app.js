...
define({
  "builder": {
    ...
    "share": {
      ...
      "btnOrg": "Organizaţie",
      "btnPublic": "Public",
      "btnEveryone": "Toată lumea"
    },
    "builderPanel": {
      "builderNamePrefix": "",
      "builderNameSuffix": "Aplicaţia Builder",
      "buttonSaving": "Se salvează",
      "buttonSaved": "Salvat",
      "buttonError": "Salvare eşuată",
      "buttonShare": "Partajare",
      "buttonSettings": "Setări",
      "settingsLogoError": "Logo-ul dvs. are o problemă. Faceţi clic pentru a afla mai multe.",
      "buttonHelp": "Obţineţi ajutor sau trimiteţi feedback despre GeoNet",
    ...
    "mediaConfig": {
      ...
      "manage": {
        ...
        "remove": "Eliminare",
        "altTextPlaceholder": "Adăugați o descriere a acestui material media pentru cititorii cu probleme de vedere...",
        "altTextHelptip": "Textul alternativ este o descriere a materialului media vizual, utilizată de tehnologiile de asistență, precum software-ul de citire a ecranului. Aceasta este opțională, dar recomandată pentru a respecta liniile directoare privind accesibilitatea web, precum WCAG și Secțiunea 508."
      },
      "appearance": {
      ...
      "browsePanel": {
        "providers": {
          ...
          "urlContent": {
            ...
            "linkText": {
              ...
              "httpsError": "Link-ul trebuie să înceapă cu HTTPS"
            },
            "embedProtocol": {
        ...
        "sidePanel": {
          ...
          "unsplash": {
            ...
            "copyrightText": "Toate fotografiile sunt licențiate în baza unei licențe ${Unsplash}. Aflați mai multe informații ${moreInfoLink}.",
            "moreInfoLink": "aici"
          },
          "flickr": {
            "searchType": {
    ...
    "mapEditor": {
      "dialogTitle": "Editare hartă",
      "unauthorizedDomain": "Nu sunteţi pe un domeniu autorizat pentru a utiliza editorul de hărţi",
      ...
      "loadFail": "Ne pare rău, editorul de hărţi nu poate fi încărcat",
      "close": "Închidere",
      "save": "Salvare",
    ...
    "mediaErrors": {
      ...
      "contentIssues": {
        ...
        "httpMedia": "Medii nesigure",
        "httpContent": "Conţinut nesigur"
      },
      "contentWarnings": {
      ...
      "descriptions": {
        ...
        "httpLogoUnfixable": "Acest logo nu acceptă HTTPS. Înlocuiţi-l cu o altă imagine.",
        "httpLogoFixable": "Acest logo are un URL nesigur (HTTP). Folosiţi un URL HTTPS pentru logo.",
        "httpLogoUncheckable": "Acest logo are un URL nesigur (HTTP). Folosiţi un URL HTTPS pentru logo sau înlocuiţi-l cu o altă imagine."
      },
      "tooltips": {
      ...
      "fixButtons": {
        "agolItemPage": "Pagină element",
        "openTheMap": "Deschidere hartă",
        "updateAudio": "Reparați URL-ul materialului audio",
        "updateWebpages": "Reparați URL-ul paginii web",
        "updateVideos": "Reparați URL-ul materialului video",
        "updateImages": "Reparați URL-ul imaginii"
      },
      "mapIssues": {
