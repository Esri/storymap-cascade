  ...
  "builder": {
    ...
    "mediaConfig": {
      ...
      "manage": {
        ...
        "remove": "Gỡ bỏ",
        "altTextPlaceholder": "Thêm thông tin mô tả phương tiện này cho những người xem khiếm thị...",
        "altTextHelptip": "Văn bản thay thế là một đoạn thông tin mô tả về phương tiện nghe nhìn được sử dụng bởi các công nghệ hỗ trợ chẳng hạn như phần mềm đọc màn hình. Phần này không bắt buộc, nhưng được khuyến nghị để đáp ứng các hướng dẫn về khả năng truy cập web chẳng hạn như WCAG và Mục 508."
      },
      "appearance": {
      ...
      "browsePanel": {
        ...
        "sidePanel": {
          ...
          "unsplash": {
            ...
            "copyrightText": "Tất cả hình ảnh được cấp phép theo Giấy phép ${Unsplash}. Tìm thêm thông tin ${moreInfoLink}.",
            "moreInfoLink": "ở đây"
          },
          "flickr": {
            "searchType": {
    ...
    "httpsTransitionMessage": {
      ...
      "s1p1": "Story Map của bạn hiển thị trực tiếp trên web, và cộng đồng web luôn nỗ lực để xây dựng và thực hiện bảo mật tốt hơn. HTTPS vốn là một kết nối bảo mật dành cho nội dung được truyền qua internet, nó đang nổi lên như là một phương thức được kỳ vọng để truy cập vào nội dung web. Các trình duyệt hiện đại nhất giờ đây đã hiển thị thông báo cảnh báo khi phát hiện việc sử dụng HTTP thay vì HTTPS. Để phù hợp với tiêu chuẩn mới, chúng tôi khuyến cáo bạn nên sử dụng các liên kết HTTPS để tạo và chia sẻ Story Map, và bạn cũng chỉ nên sử dụng URL HTTPS khi nhúng nội dung web hoặc đường dẫn vào hình ảnh trong một Story Map.",
